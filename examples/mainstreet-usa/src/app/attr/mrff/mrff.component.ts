...
@Component({
  ...
  template: `
    ...
    <p class="centered">
      <img src="./assets/mrff.jpg" class="attraction-img" alt="{{'MRFF.IMG_ALT' | translate}}" />
    </p>
    <p [translate]="'MRFF.TEXT_1'">
      This summer, skip-a-dee-doo-dah to the Cinderella Castle Forecourt stage for the fairest faire of them all!
    </p>
    <p [translate]="'MRFF.TEXT_2'">
